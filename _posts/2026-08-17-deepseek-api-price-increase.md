...
> 📌 **版本 v2.1** · 初版 2026-08-17 · 更新 2026-08-27（新增 GLM-5.3-Flash 对比）· 更新 2026-09-09（Flash 系列降价，各表已按 9/10 新价同步）
...
| **2026-09-10** | **Flash 新价 12:00 生效（Pro 不变）** |

---

## 三、价格总览（官方，含全版本对照）

> 单位：元 / 百万 tokens。高峰时段 = 北京时间 9:00–12:00、14:00–18:00（其余为空闲时段）；空闲价 = 高峰价的 1/2。官方页未注明是否仅限工作日，第三方实测为每日 7 小时峰时。
...
| 模型 | 计费项 | 空闲时段 | 高峰时段 |
|---|---|---|---|
| V4-Flash | 输入（缓存命中） | 0.02 | 0.04 |
| V4-Flash | 输入（缓存未命中） | 1.0 | 2.0 |
| V4-Flash | 输出 | 4.0 | 8.0 |
...
| 模型 | 输入 | 输出 | 备注 |
|---|---|---|---|
| DeepSeek V4-Flash | 1.0 / 2.0 | 4.0 / 8.0 | 空闲 / 高峰；9/10 降价后 |
...
（DeepSeek Flash 一列为 9/10 降价后新价；8/17–9/9 旧价为 0.05/0.10、1.5/3.0、4.5/9.0）
...
- DeepSeek 官方定价页（api-docs.deepseek.com）及 9/9 开放平台调价公告（界面新闻/澎湃/新浪报道）
